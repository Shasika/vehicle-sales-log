...
function NavigationContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
              ...
              <Link href="/" className="flex items-center space-x-1 sm:space-x-2 group">
                ...
                <div className="hidden md:block">
                  <div className="flex flex-col">
                    <span className="text-base sm:text-lg font-bold text-gray-900">Vehicle Sales Log</span>
                    <span className="text-xs text-blue-600 -mt-1 hidden sm:block">Business Management</span>
                  </div>
                </div>
                <span className="text-base sm:text-lg font-bold text-blue-600 block md:hidden">VSL</span>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <div className="hidden lg:flex items-center space-x-2">
                <div className="flex items-center space-x-2 bg-gray-50 rounded-lg px-2 py-1.5">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-medium text-gray-900 leading-tight">{session?.user?.name}</span>
                    <span className="text-xs text-gray-500 leading-tight">{session?.user?.role}</span>
                  </div>
                </div>
                <button
                  onClick={handleSignOut}
                  className="flex items-center space-x-1 px-2 py-1.5 text-xs font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-md transition-colors"
                >
              ...
              <button
                ...
                className="lg:hidden inline-flex items-center justify-center p-1.5 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors"
              >
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed top-14 sm:top-16 left-0 right-0 z-40 bg-white border-b border-gray-200 shadow-lg">
