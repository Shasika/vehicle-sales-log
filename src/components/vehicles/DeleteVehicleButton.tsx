...
export default function DeleteVehicleButton({ vehicleId, registrationNumber }: DeleteVehicleButtonProps) {
  ...
  return (
    <Button
      variant="outline"
      className="inline-flex items-center justify-center px-4 py-2 text-red-600 border-red-300 hover:bg-red-50 dark:hover:bg-red-950 transition-colors text-sm font-medium"
